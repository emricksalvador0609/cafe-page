...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center text-white bg-cover bg-center px-6 transition-opacity duration-1000"
      style={{
        backgroundImage:
          "url('https://caafe-bliss.netlify.app/hero-bg.jpg')",
      }}
    >
